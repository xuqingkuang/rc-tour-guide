	...
	exports.default = function (options, done) {
	  ...
	  return {
	    ...
	    _renderLayer: function _renderLayer() {
	      ...
	      _reactDom2.default.render(this.renderCurrentStep(), this._target);
	      this.calculatePosition();
	    },
	
	    _unrenderLayer: function _unrenderLayer() {
	      _reactDom2.default.unmountComponentAtNode(this._target);
	    },
	
	    componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
	      var hasNewIndex = this.state.currentIndex !== prevState.currentIndex;
	      var hasNewStep = !!this.options.steps[this.state.currentIndex];
	      var hasSteps = this.options.steps.length > 0;
	      var hasNewX = this.state.xPos !== prevState.xPos;
	      var hasNewY = this.state.yPos !== prevState.yPos;
	      var didToggleTooltip = this.state.show && this.state.show !== prevState.show;
	    ...
	    componentDidMount: function componentDidMount() {
	      ...
	      (0, _jquery2.default)(window).on('resize', this.calculatePosition);
	    },
	
	    componentWillUnmount: function componentWillUnmount() {
	      this._unrenderLayer();
	      document.body.removeChild(this._target);
	      (0, _jquery2.default)(window).off('resize', this.calculatePosition);
	    },
	
	    setTourSteps: function setTourSteps(steps, cb) {
	    ...
	    preventWindowOverflow: function preventWindowOverflow(value, axis, elWidth, elHeight) {
	    ...
	    calculatePosition: function calculatePosition() {
	      ...
	      var $element = (0, _jquery2.default)('.rc-tour-tooltip');
	    ...
	    scrollToNextStep: function scrollToNextStep() {
	      var $next = (0, _jquery2.default)('.rc-tour-guide-indicator');
	    ...
	    renderCurrentStep: function renderCurrentStep() {
	      ...
	      if (this.state.show && $target && $target.length) {
	        ...
	        element = _react2.default.createElement('div', { className: 'rc-tour-guide-indicator' });
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tooltip = function (_Component) {
	  ...
	  Tooltip.prototype.renderButtons = function renderButtons() {
	    var _props = this.props;
	    var locale = _props.locale;
	    var extraButtons = _props.extraButtons;
	  ...
	  Tooltip.prototype.render = function render() {
	    ...
	    var targetXPos = _props2.targetXPos;
	    var targetYPos = _props2.targetYPos;
	    var targetWidth = _props2.targetWidth;
	    ...
	    var arrowClassName = 'rc-tour-arrow ' + placement;
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'rc-tour-tooltip', style: toolTipStyles },
	        _react2.default.createElement(
	          'p',
	          null,
	          text || ''
	...
	Tooltip.propTypes = {
	  ...
	  targetXPos: _react.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.string]).isRequired,
	  targetYPos: _react.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.string]).isRequired,
	  targetWidth: _react.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.string]).isRequired,
	  targetHeight: _react.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.string]).isRequired,
	  text: _react.PropTypes.string.isRequired,
	  extraButtons: _react.PropTypes.array,
	  isFirst: _react.PropTypes.bool.isRequired,
	  isLast: _react.PropTypes.bool.isRequired,
	  hideTourGuide: _react.PropTypes.func.isRequired,
